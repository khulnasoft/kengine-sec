...
import (
	...
	"github.com/khulnasoft-lab/golang_sdk/client"
	"github.com/khulnasoft-lab/golang_sdk/utils/http"
)
...
func newClient() (*http.OpenapiHttpClient, error) {
	...
	apiToken := os.Getenv("KHULNASOFT_KEY")
	if strings.Trim(apiToken, "\"") == "" && http.IsConsoleAgent(url) {
		...
		return nil, errors.New("KHULNASOFT_KEY not set")
	}
