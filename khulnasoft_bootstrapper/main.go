...
import (
	...
	"github.com/khulnasoft/kengine/khulnasoft_bootstrapper/cgroups"
	"github.com/khulnasoft/kengine/khulnasoft_bootstrapper/config"
	"github.com/khulnasoft/kengine/khulnasoft_bootstrapper/controls"
	"github.com/khulnasoft/kengine/khulnasoft_bootstrapper/router"
	"github.com/khulnasoft/kengine/khulnasoft_bootstrapper/server"
	"github.com/khulnasoft/kengine/khulnasoft_bootstrapper/supervisor"
...
func main() {
	...
	err = server.StartRPCServer(ctx, "/tmp/khulnasoft_boot.sock")
	if err != nil {
		log.Panic().Msgf("%v", err)
	}
