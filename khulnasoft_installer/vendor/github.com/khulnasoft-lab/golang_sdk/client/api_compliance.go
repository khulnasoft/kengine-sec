...
func (r ApiCountResultsComplianceScanRequest) ModelScanResultsReq(modelScanResultsReq ModelScanResultsReq) ApiCountResultsComplianceScanRequest {
	r.modelScanResultsReq = &modelScanResultsReq
	return r
}

func (r ApiCountResultsComplianceScanRequest) Execute() (*SearchSearchCountResp, *http.Response, error) {
	return r.ApiService.CountResultsComplianceScanExecute(r)
}
...
func (a *ComplianceAPIService) CountResultsComplianceScanExecute(r ApiCountResultsComplianceScanRequest) (*SearchSearchCountResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/scan/results/count/compliance"
...
func (r ApiIngestComplianceScanStatusRequest) IngestersComplianceScanStatus(ingestersComplianceScanStatus []IngestersComplianceScanStatus) ApiIngestComplianceScanStatusRequest {
	r.ingestersComplianceScanStatus = &ingestersComplianceScanStatus
	return r
}

func (r ApiIngestComplianceScanStatusRequest) Execute() (*http.Response, error) {
	return r.ApiService.IngestComplianceScanStatusExecute(r)
}
...
func (a *ComplianceAPIService) IngestComplianceScanStatusExecute(r ApiIngestComplianceScanStatusRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ComplianceAPIService.IngestComplianceScanStatus")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/khulnasoft/ingest/compliance-scan-logs"
	...
	// body params
	localVarPostBody = r.ingestersComplianceScanStatus
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
func (r ApiIngestCompliancesRequest) IngestersCompliance(ingestersCompliance []IngestersCompliance) ApiIngestCompliancesRequest {
	r.ingestersCompliance = &ingestersCompliance
	return r
}
...
func (a *ComplianceAPIService) IngestCompliancesExecute(r ApiIngestCompliancesRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/ingest/compliance"
	...
	// body params
	localVarPostBody = r.ingestersCompliance
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
func (r ApiListComplianceScanRequest) Execute() (*ModelScanListResp, *http.Response, error) {
	return r.ApiService.ListComplianceScanExecute(r)
}
...
func (a *ComplianceAPIService) ListComplianceScanExecute(r ApiListComplianceScanRequest) (*ModelScanListResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/scan/list/compliance"
...
func (a *ComplianceAPIService) ResultsComplianceScanExecute(r ApiResultsComplianceScanRequest) (*ModelComplianceScanResult, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/scan/results/compliance"
...
func (r ApiStartComplianceScanRequest) Execute() (*ModelScanTriggerResp, *http.Response, error) {
...
func (a *ComplianceAPIService) StartComplianceScanExecute(r ApiStartComplianceScanRequest) (*ModelScanTriggerResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/scan/start/compliance"
...
func (a *ComplianceAPIService) StatusComplianceScanExecute(r ApiStatusComplianceScanRequest) (*ModelScanStatusResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/scan/status/compliance"
...
func (r ApiStopComplianceScanRequest) Execute() (*http.Response, error) {
	return r.ApiService.StopComplianceScanExecute(r)
}
...
func (a *ComplianceAPIService) StopComplianceScanExecute(r ApiStopComplianceScanRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/scan/stop/compliance"
