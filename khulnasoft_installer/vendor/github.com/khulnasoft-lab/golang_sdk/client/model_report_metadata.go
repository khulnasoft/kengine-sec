...
type ReportMetadata struct {
	...
	IsKhulnasoftSystem *bool `json:"is_khulnasoft_system,omitempty"`
...
// GetIsKhulnasoftSystem returns the IsKhulnasoftSystem field value if set, zero value otherwise.
func (o *ReportMetadata) GetIsKhulnasoftSystem() bool {
	if o == nil || IsNil(o.IsKhulnasoftSystem) {
		var ret bool
		return ret
	}
	return *o.IsKhulnasoftSystem
}

// GetIsKhulnasoftSystemOk returns a tuple with the IsKhulnasoftSystem field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportMetadata) GetIsKhulnasoftSystemOk() (*bool, bool) {
	if o == nil || IsNil(o.IsKhulnasoftSystem) {
		return nil, false
	}
	return o.IsKhulnasoftSystem, true
}
...
// SetIsKhulnasoftSystem gets a reference to the given bool and assigns it to the IsKhulnasoftSystem field.
func (o *ReportMetadata) SetIsKhulnasoftSystem(v bool) {
	o.IsKhulnasoftSystem = &v
}
...
func (o ReportMetadata) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsKhulnasoftSystem) {
		toSerialize["is_khulnasoft_system"] = o.IsKhulnasoftSystem
	}
	if !IsNil(o.KernelId) {
