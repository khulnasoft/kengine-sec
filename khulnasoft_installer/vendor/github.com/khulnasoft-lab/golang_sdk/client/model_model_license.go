...
type ModelLicense struct {
	...
	KhulnasoftSupportEmail *string `json:"khulnasoft_support_email,omitempty"`
...
// GetKhulnasoftSupportEmail returns the KhulnasoftSupportEmail field value if set, zero value otherwise.
func (o *ModelLicense) GetKhulnasoftSupportEmail() string {
	if o == nil || IsNil(o.KhulnasoftSupportEmail) {
		var ret string
		return ret
	}
	return *o.KhulnasoftSupportEmail
}

// GetKhulnasoftSupportEmailOk returns a tuple with the KhulnasoftSupportEmail field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ModelLicense) GetKhulnasoftSupportEmailOk() (*string, bool) {
	if o == nil || IsNil(o.KhulnasoftSupportEmail) {
		return nil, false
	}
	return o.KhulnasoftSupportEmail, true
}
...
// SetKhulnasoftSupportEmail gets a reference to the given string and assigns it to the KhulnasoftSupportEmail field.
func (o *ModelLicense) SetKhulnasoftSupportEmail(v string) {
	o.KhulnasoftSupportEmail = &v
}
...
func (o ModelLicense) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.KhulnasoftSupportEmail) {
		toSerialize["khulnasoft_support_email"] = o.KhulnasoftSupportEmail
	}
