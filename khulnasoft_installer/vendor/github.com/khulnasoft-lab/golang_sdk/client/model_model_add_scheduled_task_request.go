...
type ModelAddScheduledTaskRequest struct {
	...
	KhulnasoftSystemScan *bool `json:"khulnasoft_system_scan,omitempty"`
...
// GetKhulnasoftSystemScan returns the KhulnasoftSystemScan field value if set, zero value otherwise.
func (o *ModelAddScheduledTaskRequest) GetKhulnasoftSystemScan() bool {
	if o == nil || IsNil(o.KhulnasoftSystemScan) {
		var ret bool
		return ret
	}
	return *o.KhulnasoftSystemScan
}

// GetKhulnasoftSystemScanOk returns a tuple with the KhulnasoftSystemScan field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ModelAddScheduledTaskRequest) GetKhulnasoftSystemScanOk() (*bool, bool) {
	if o == nil || IsNil(o.KhulnasoftSystemScan) {
		return nil, false
	}
	return o.KhulnasoftSystemScan, true
}
...
// SetKhulnasoftSystemScan gets a reference to the given bool and assigns it to the KhulnasoftSystemScan field.
func (o *ModelAddScheduledTaskRequest) SetKhulnasoftSystemScan(v bool) {
	o.KhulnasoftSystemScan = &v
}
...
func (o ModelAddScheduledTaskRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.KhulnasoftSystemScan) {
		toSerialize["khulnasoft_system_scan"] = o.KhulnasoftSystemScan
	}
