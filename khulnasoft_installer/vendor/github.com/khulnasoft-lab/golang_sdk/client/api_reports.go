...
type ApiBulkDeleteReportsRequest struct {
	ctx context.Context
	ApiService *ReportsAPIService
	modelBulkDeleteReportReq *ModelBulkDeleteReportReq
}

func (r ApiBulkDeleteReportsRequest) ModelBulkDeleteReportReq(modelBulkDeleteReportReq ModelBulkDeleteReportReq) ApiBulkDeleteReportsRequest {
	r.modelBulkDeleteReportReq = &modelBulkDeleteReportReq
	return r
}

func (r ApiBulkDeleteReportsRequest) Execute() (*http.Response, error) {
	return r.ApiService.BulkDeleteReportsExecute(r)
}

/*
BulkDeleteReports Bulk Delete Reports

Bulk Delete reports

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiBulkDeleteReportsRequest
*/
func (a *ReportsAPIService) BulkDeleteReports(ctx context.Context) ApiBulkDeleteReportsRequest {
	return ApiBulkDeleteReportsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ReportsAPIService) BulkDeleteReportsExecute(r ApiBulkDeleteReportsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReportsAPIService.BulkDeleteReports")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/khulnasoft/reports/delete"
	...
	// body params
	localVarPostBody = r.modelBulkDeleteReportReq
...
func (a *ReportsAPIService) DeleteReportExecute(r ApiDeleteReportRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/reports/{report_id}"
...
func (a *ReportsAPIService) GenerateReportExecute(r ApiGenerateReportRequest) (*ModelGenerateReportResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/reports"
