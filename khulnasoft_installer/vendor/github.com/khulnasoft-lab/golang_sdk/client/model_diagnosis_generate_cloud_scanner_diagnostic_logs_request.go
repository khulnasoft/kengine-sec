...
func (o *DiagnosisGenerateCloudScannerDiagnosticLogsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varDiagnosisGenerateCloudScannerDiagnosticLogsRequest)
