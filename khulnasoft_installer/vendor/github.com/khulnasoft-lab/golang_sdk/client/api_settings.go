...
func (a *SettingsAPIService) AddEmailConfigurationExecute(r ApiAddEmailConfigurationRequest) (*ModelMessageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/settings/email"
...
func (a *SettingsAPIService) AddScheduledTaskExecute(r ApiAddScheduledTaskRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/scheduled-task"
...
func (a *SettingsAPIService) DeleteCustomScheduledTaskExecute(r ApiDeleteCustomScheduledTaskRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/scheduled-task/{id}"
...
func (a *SettingsAPIService) DeleteEmailConfigurationExecute(r ApiDeleteEmailConfigurationRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/settings/email/{config_id}"
...
func (a *SettingsAPIService) DeleteLicenseExecute(r ApiDeleteLicenseRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/license"
...
Generate a new Kengine license key
...
func (a *SettingsAPIService) GenerateLicenseExecute(r ApiGenerateLicenseRequest) (*ModelGenerateLicenseResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/license/generate"
...
func (a *SettingsAPIService) GetAgentBinaryDownloadURLExecute(r ApiGetAgentBinaryDownloadURLRequest) (*ModelGetAgentBinaryDownloadURLResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/agent-deployment/binary/download-url"
...
func (a *SettingsAPIService) GetAgentVersionsExecute(r ApiGetAgentVersionsRequest) (*ModelListAgentVersionResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/settings/agent/versions"
...
func (a *SettingsAPIService) GetSettingsExecute(r ApiGetSettingsRequest) ([]ModelSettingsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/settings/global-settings"
...
func (a *SettingsAPIService) GetUserAuditLogsExecute(r ApiGetUserAuditLogsRequest) ([]PostgresqlDbGetAuditLogsRow, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/settings/user-audit-log"
...
func (a *SettingsAPIService) GetUserAuditLogsCountExecute(r ApiGetUserAuditLogsCountRequest) (*SearchSearchCountResp, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/settings/user-audit-log/count"
...
func (a *SettingsAPIService) TestConfiguredEmailExecute(r ApiTestConfiguredEmailRequest) (*ModelMessageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/settings/email/test"
...
func (a *SettingsAPIService) TestUnconfiguredEmailExecute(r ApiTestUnconfiguredEmailRequest) (*ModelMessageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/settings/email/test-unconfigured"
...
func (a *SettingsAPIService) UpdateSettingExecute(r ApiUpdateSettingRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/settings/global-settings/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (a *SettingsAPIService) UploadAgentVersionExecute(r ApiUploadAgentVersionRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/settings/agent/version"
...
func (a *SettingsAPIService) UploadMalwareRulesExecute(r ApiUploadMalwareRulesRequest) (*ModelMessageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/database/malware"
...
func (a *SettingsAPIService) UploadPostureControlsExecute(r ApiUploadPostureControlsRequest) (*ModelMessageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/database/posture"
...
func (a *SettingsAPIService) UploadSecretsRulesExecute(r ApiUploadSecretsRulesRequest) (*ModelMessageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/database/secret"
...
func (a *SettingsAPIService) UploadVulnerabilityDatabaseExecute(r ApiUploadVulnerabilityDatabaseRequest) (*ModelMessageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/khulnasoft/database/vulnerability"
