...
func (o *DiagnosisGenerateConsoleDiagnosticLogsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varDiagnosisGenerateConsoleDiagnosticLogsRequest)
