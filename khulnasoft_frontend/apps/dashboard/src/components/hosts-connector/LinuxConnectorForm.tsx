...
const PLACEHOLDER_API_KEY = '---KHULNASOFT-API-KEY--';
      ...
      <Stepper>
        ...
        >
          <div className="text-p7a text-text-text-and-icon">
            ...
            <DFLink
              href={`https://community.khulnasoft.com/kengine/docs/v2.2/sensors/linux-host`}
              target="_blank"
              rel="noreferrer"
              className="mt-2"
            >
        ...
        >
          <div>
            <p className="mb-2.5 text-p7a text-text-text-and-icon">
              ...
              <DFLink
                href={`https://community.khulnasoft.com/kengine/docs/v2.2/sensors/linux-host#kengine-sensor-agents`}
                target="_blank"
                rel="noreferrer"
                className="mt-2"
              >
              ...
              <b>install_khulnasoft_agent.sh</b>
            </p>
          </div>
        </Step>
        <Step
...
export KHULNASOFT_KEY="${PLACEHOLDER_API_KEY}"`}
                />
              </Suspense>
            </Card>
          </div>
        ...
        <Step
          ...
          title="Start Khulnasoft agent"
        >
          <div>
            <p className="mb-2.5 text-p7a text-text-text-and-icon">
              Run the following command as a privileged user to start Khulnasoft agent.
            </p>
            <Card className="w-full relative py-2 px-4">
              <Command command="sudo bash install_khulnasoft_agent.sh" />
            </Card>
          </div>
          <div className="mt-4">
            <p className="mb-2.5 text-p7a text-text-text-and-icon">
              This will also create a new file <b>uninstall_khulnasoft.sh</b>. You can run
              to to uninstall Khulnasoft agent.
            </p>
            <Card className="w-full relative py-2 px-4">
              <Command command="sudo bash uninstall_khulnasoft.sh" />
            </Card>
          </div>
        </Step>
      </Stepper>
