...
const Links = ({ region }: { region: string }) => {
  ...
  return (
    <>
      ...
      <DFLink
        href="https://khulnasoft-public.s3.amazonaws.com/cloud-scanner/khulnasoft-cloud-scanner.template"
        target="_blank"
        rel="noreferrer"
        className="mt-2"
      >
      ...
      <DFLink
        href={
          'https://khulnasoft-public.s3.amazonaws.com/cloud-scanner/khulnasoft-cloud-scanner-org-common.template'
        }
        target="_blank"
        rel="noreferrer"
        className="mt-2"
      ...
      <Stepper>
        ...
        >
          <div className="text-p7a text-text-text-and-icon">
            ...
            information by{' '}
            <Link
              to="https://community.khulnasoft.com/kengine/docs/v2.2/cloudscanner/aws#cloudformation"
        ...
        >
          <div className="text-p7a text-text-text-and-icon">
            <p>
              Deploy all modules for Khulnasoft Posture Scanner for a single account. For
