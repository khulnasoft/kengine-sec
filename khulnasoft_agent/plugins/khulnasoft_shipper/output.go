...
import (
	...
	dfUtils "github.com/khulnasoft/kengine/khulnasoft_utils/utils"
	dsc "github.com/khulnasoft/golang_sdk/client"
	dschttp "github.com/khulnasoft/golang_sdk/utils/http"
...
func Authenticate(url string, apiToken string) (string, string, error) {
	...
	cfg.Servers = dsc.ServerConfigurations{
		{URL: url, Description: "khulnasoft_server"},
	}
