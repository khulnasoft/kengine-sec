module github.com/khulnasoft/kengine/khulnasoft_agent/tools/apache/khulnasoft/df-utils/cloud_metadata
...
require github.com/khulnasoft/df-utils v0.0.0-00010101000000-000000000000
