module github.com/khulnasoft/kengine/khulnasoft_agent/tools/apache/khulnasoft/ke-utils/cloud_metadata
...
require github.com/khulnasoft/ke-utils v0.0.0-00010101000000-000000000000
