...
var topCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		orderFilter := khulnasoft_server_client.ReportersOrderFilter{
			OrderFields: []khulnasoft_server_client.ReportersOrderSpec{{FieldName: type2field(search_type)}},
		}

		filtreq := khulnasoft_server_client.SearchSearchNodeReq{
			NodeFilter: khulnasoft_server_client.SearchSearchFilter{
			...
			Window: khulnasoft_server_client.ModelFetchWindow{Offset: 0, Size: int32(num)},
		}
...
var issuesCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		filtreq := khulnasoft_server_client.SearchSearchNodeReq{
			...
			Window: khulnasoft_server_client.ModelFetchWindow{Offset: 0, Size: 0},
		}
