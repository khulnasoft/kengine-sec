...
var scanStartSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		identifiers := []khulnasoft_server_client.ModelNodeIdentifier{}
		for i := range scan_node_ids {
			identifiers = append(identifiers, khulnasoft_server_client.ModelNodeIdentifier{
		...
		var err error
		var res *khulnasoft_server_client.ModelScanTriggerResp
		switch scan_type {
		case "secret":
			req := http.Client().SecretScanAPI.StartSecretScan(context.Background())
			req = req.ModelSecretScanTriggerReq(
				*khulnasoft_server_client.NewModelSecretScanTriggerReq(
					*khulnasoft_server_client.NewModelScanFilterWithDefaults(),
					identifiers,
				))
		...
		case "malware":
			...
			req = req.ModelMalwareScanTriggerReq(
				*khulnasoft_server_client.NewModelMalwareScanTriggerReq(
					*khulnasoft_server_client.NewModelScanFilterWithDefaults(),
					identifiers,
				))
		...
		case "vulnerability":
			...
			req = req.ModelVulnerabilityScanTriggerReq(
				*khulnasoft_server_client.NewModelVulnerabilityScanTriggerReq(
					*khulnasoft_server_client.NewModelScanFilterWithDefaults(),
					identifiers,
					[]khulnasoft_server_client.ModelVulnerabilityScanConfigLanguage{*khulnasoft_server_client.NewModelVulnerabilityScanConfigLanguage(vuln_scan_type)},
				))
		...
		case "compliance":
			...
			req = req.ModelComplianceScanTriggerReq(
				*khulnasoft_server_client.NewModelComplianceScanTriggerReq(
					strings.Split(scan_config, ","),
					*khulnasoft_server_client.NewModelScanFilterWithDefaults(),
					[]khulnasoft_server_client.ModelNodeIdentifier{
						{
							NodeId:   scan_node_id,
							NodeType: resource_type,
						},
...
var scanStatusSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		var err error
		var res *khulnasoft_server_client.ModelScanStatusResp
		var res2 *khulnasoft_server_client.ModelComplianceScanStatusResp
		switch scan_type {
		case "secret":
			req := http.Client().SecretScanAPI.StatusSecretScan(context.Background())
			req = req.ModelScanStatusReq(*khulnasoft_server_client.NewModelScanStatusReq(
				scan_id,
				[]string{},
			))
...
var scanListSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		var err error
		var res *khulnasoft_server_client.ModelScanListResp
		switch scan_type {
		case "secret":
			req := http.Client().SecretScanAPI.ListSecretScan(context.Background())
			req = req.ModelScanListReq(khulnasoft_server_client.ModelScanListReq{
				NodeIds: []khulnasoft_server_client.ModelNodeIdentifier{{NodeId: node_id, NodeType: node_type}},
...
var scanSearchSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		scan_filters := khulnasoft_server_client.SearchSearchFilter{}
		if scan_filter != "" {
			orderFilter := khulnasoft_server_client.ReportersOrderFilter{}
			...
			scan_filters = khulnasoft_server_client.SearchSearchFilter{
				...
				Filters: khulnasoft_server_client.ReportersFieldsFilters{
					ContainsFilter: khulnasoft_server_client.ReportersContainsFilter{
						FilterIn: sfields,
					},
					MatchFilter: khulnasoft_server_client.ReportersMatchFilter{
		...
		node_filters := khulnasoft_server_client.SearchSearchFilter{}
		if node_filter != "" {
			orderFilter := khulnasoft_server_client.ReportersOrderFilter{}
		...
		var err error
		var res []khulnasoft_server_client.ModelScanInfo
		switch scan_type {
		case "secret":
			req := http.Client().SearchAPI.SearchSecretsScans(context.Background())
			req = req.SearchSearchScanReq(khulnasoft_server_client.SearchSearchScanReq{
...
var scanResultsSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		case "secret":
			...
			req = req.ModelScanResultsReq(khulnasoft_server_client.ModelScanResultsReq{
				ScanId: scan_id,
				Window: khulnasoft_server_client.ModelFetchWindow{
					Offset: 0,
					Size:   20,
		...
		case "vulnerability":
			...
			req = req.ModelScanResultsReq(khulnasoft_server_client.ModelScanResultsReq{
				ScanId: scan_id,
				FieldsFilter: khulnasoft_server_client.ReportersFieldsFilters{
					ContainsFilter: khulnasoft_server_client.ReportersContainsFilter{
...
var scanStopSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		stopReq := khulnasoft_server_client.ModelStopScanRequest{
			ScanIds: scan_ids,
		}
