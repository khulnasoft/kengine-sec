...
var scheduleTaskAddSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		filters := khulnasoft_server_client.SearchSearchFilter{}
		...
		cFilters := khulnasoft_server_client.ReportersContainsFilter{
		...
		var mAddTaskReq khulnasoft_server_client.ModelAddScheduledTaskRequest
