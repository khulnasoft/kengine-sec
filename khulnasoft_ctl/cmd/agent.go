...
var agentUpgradeSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		req = req.ModelAgentUpgrade(khulnasoft_server_client.ModelAgentUpgrade{
			NodeId:  node_ids,
			Version: version,
		})
...
var agentEnableSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		req = req.ModelAgentPluginEnable(khulnasoft_server_client.ModelAgentPluginEnable{
			NodeId:     node_ids,
			Version:    version,
...
var agentDisableSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		req = req.ModelAgentPluginDisable(khulnasoft_server_client.ModelAgentPluginDisable{
			NodeId:     node_ids,
			PluginName: plugin_name,
		})
