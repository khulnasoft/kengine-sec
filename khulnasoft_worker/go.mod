module github.com/khulnasoft/kengine/khulnasoft_worker
...
replace github.com/khulnasoft-lab/YaraHunter => ../khulnasoft_agent/plugins/YaraHunter

replace github.com/khulnasoft/kengine/khulnasoft_server => ../khulnasoft_server/
