...
import (
	...
	"github.com/khulnasoft/kengine/khulnasoft_server/pkg/integration"
	"github.com/khulnasoft/kengine/khulnasoft_server/reporters"
	reporters_scan "github.com/khulnasoft/kengine/khulnasoft_server/reporters/scan"
...
func init() {
	backoffTimeStr := os.Getenv("KHULNASOFT_NOTIFICATION_ERROR_BACKOFF_MINUTES")
	status := false
