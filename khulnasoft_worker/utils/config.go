...
type Config struct {
	...
	KafkaBrokers          []string `default:"khulnasoft-kafka-broker:9092" required:"true" split_words:"true"`
	...
	RedisHost             string   `default:"khulnasoft-redis" required:"true" split_words:"true"`
